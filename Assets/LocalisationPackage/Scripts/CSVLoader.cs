...
public class CSVLoader
{
    ...
    public void Add(string key, string value) {
        ...
        File.AppendAllText("Assets/LocalisationPackage/Resources/localisation.csv", appended);
    ...
    public void Remove(string key) {
        ...
        if (index > -1) {
            ...
            File.WriteAllText("Assets/LocalisationPackage/Resources/localisation.csv", replaced);
